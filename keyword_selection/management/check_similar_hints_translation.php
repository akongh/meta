...
require($_SERVER["DOCUMENT_ROOT"] . '/keyword_selection/management/sql/SQL_choice.php');
...
mysqli_close( $mysqli );
require($_SERVER["DOCUMENT_ROOT"] . '/keyword_selection/management/includes/check_similar_hints_translation.php');