...
if ( isset( $slovo ) ) {
    ...
    require($_SERVER["DOCUMENT_ROOT"] . '/keyword_selection/management/includes/translation_hint.php');
} else {
    require($_SERVER["DOCUMENT_ROOT"] . '/keyword_selection/management/includes/no_hints_for_translation.php');
}
