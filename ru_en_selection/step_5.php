...
<div class="wrap">
    ...
    <form method="post"
          action="/ru_en_selection/step_5_to_6.php">
...
<script src="/ru_en_selection/js/countUniqEngChecked.js"></script>
<script src="/ru_en_selection/js/uncheckedTranslations.js"></script>
</body>
</html>
