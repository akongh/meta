...
if (isset($slovo)) {
    ...
    require($_SERVER["DOCUMENT_ROOT"] . '/ru_en_selection/management/includes/translation_hint.php');
} else {
    require($_SERVER["DOCUMENT_ROOT"] . '/ru_en_selection/management/includes/no_hints_for_translation.php');
}
