...
<div class="wrap">
    ...
    <hr class="otbivka_96">
    <form method="post" action="/ru_en_selection/management/php/ex_save_request_translation.php">
    ...
    <hr class="otbivka_24">
    <div class="upravlenie"><a href="/ru_en_selection/management/php/ex_omit_by_request.php" title="Пропустить">&#9660; Пропустить</a> —
