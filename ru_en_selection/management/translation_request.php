...
if (isset($slovo)) {
    ...
    require($_SERVER["DOCUMENT_ROOT"] . '/ru_en_selection/management/includes/translation_request.php');
} else {
    require($_SERVER["DOCUMENT_ROOT"] . '/ru_en_selection/management/includes/no_request_for_translation.php');
}
