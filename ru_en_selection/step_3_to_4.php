...
if (!isset($_POST["arr_kws_marked"]) || count($_POST["arr_kws_marked"]) < 8) {
    ...
    $_SESSION["error_messages"][] = meta_error_message(4);
    header("Location: //" . $_SERVER["HTTP_HOST"] . "/ru_en_selection/step_3.php");
    exit;
} else {
    $_SESSION["arr_kws_assembled_marked"] = $_POST["arr_kws_marked"];
...
header("Location: //" . $_SERVER["HTTP_HOST"] . "/ru_en_selection/step_4.php");
