...
<hr class=\"otbivka_48\"></span>";
				...
				{
				$neperevedennye[$i] = $rus[$i];
				$s_perevodom[$i] = "<span class = \"russk\"><input type=\"checkbox\" name=\"russk[]\" checked value = '".$rus[$i]."' hidden=\"true\">".$rus[$i]."</span><hr class=\"otbivka_6\"><span class = \"perevod_v_zayavke\">* В заявке на перевод<input type=\"checkbox\" name=\"zayavka[]\" checked value = '".$rus[$i]."' hidden=\"true\"></span>";
