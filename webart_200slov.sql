...
--
-- Хост: localhost:3306
-- Время создания: Фев 12 2015 г., 16:30
...
CREATE TABLE IF NOT EXISTS `k_l` (
  ...
  KEY `idl` (`idl`),
  KEY `idz` (`idz`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=13659 ;
...
CREATE TABLE IF NOT EXISTS `l-tn` (
  ...
  KEY `vr` (`vr`),
  KEY `ses` (`ses`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Наборы на латинице' AUTO_INCREMENT=6568 ;
...
CREATE TABLE IF NOT EXISTS `l-ts` (
  ...
  PRIMARY KEY (`ids`),
  UNIQUE KEY `s` (`s`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Слова на латинице' AUTO_INCREMENT=85098 ;
...
CREATE TABLE IF NOT EXISTS `l-t_s` (
  ...
  KEY `id_s` (`id_s`),
  KEY `id_n` (`id_n`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Связи для латиницы' AUTO_INCREMENT=70810 ;
...
CREATE TABLE IF NOT EXISTS `tz` (
  ...
  PRIMARY KEY (`idz`),
  UNIQUE KEY `z` (`z`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=13658 ;
